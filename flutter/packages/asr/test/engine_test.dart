...
void main() {
  group('AsrEngine & Implementations', () {
    ...
    test(
      'MockAsrEngine simulates streaming chunk delivery and finalization',
      () async {
    ...
    test(
      'NonStreamingAsrEngine accumulates full buffer and decodes on finish',
      () async {
        ...
        expect(
          chunks,
          isEmpty,
        ); // Non-streaming produces no intermediate chunks
